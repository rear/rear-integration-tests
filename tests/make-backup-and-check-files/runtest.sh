...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#
#   runtest.sh of /CoreOS/rear/Sanity/make-backup-and-check-files
#   Description: Rear creates backup and rescue and check created files (tar.gz and iso).
...
\" > /etc/rear/local.conf"
    ...
    rlPhaseStartTest "Run REAR backup"
        rlRun "rear -v mkbackup > output"
        rlRun "cat output"
    rlPhaseEnd
